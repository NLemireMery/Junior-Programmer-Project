...
public class OptimUnit : MonoBehaviour
{
    ...
    void Update()
    {
        Profiler.BeginSample("Handling Time"); /* begins profiling a piece of code with a custom label */
        HandleTime();
        Profiler.EndSample(); /* ends the current profiling sample */

        Profiler.BeginSample("Rotating"); // begins profiling
        var t = transform;
        ...
        Profiler.EndSample(); /* ends profiling */

        Profiler.BeginSample("Moving"); // begins profiling
        Move();
        Profiler.EndSample(); /* ends profiling */

        Profiler.BeginSample("Boundary Check"); // begins profiling
